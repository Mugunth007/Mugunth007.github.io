          ...
          <div className=" h-[calc(100vh_-_6.1rem)] sm:h-[calc(100vh_-_6.6rem)] md:h-[calc(100vh_-_7.8rem)] flex flex-col mt-6 md:mt-0 md:grid grid-cols-3 items-center md:divide-x sm:divide-orange-400 md:gap-10 md:gap-x-10">
            ...
            >
              ...
              <p className="mt-2 sm:mt-5 text-justify">
                ...
                Technology from Vellore Institute of Technology and my specialization 
                is in CSE with specialization in data science.
                <br />
                I have a deep interest in Web Development especially in frontend development 
                and Data Science and I have made some full
                data science using machine learning and deep learning then also worked with transfer learnings
                and also done web dev projects using React and next. My
              ...
              <a
                ...
                href="https://drive.google.com/file/d/1oxX7UanooUMdAf0YFhvhTKo-o9itLvGt/view"
                target="_blank"
                rel="noreferrer"
              >
