...
import ProfileImage2 from "../assets/profile.jpeg";
            ...
            <div className="flex flex-col">
              <NavLink to="/projects" className="flex flex-col group ">
                ...
                <p className="text-sm text-[#65696E] mt-2">
                  Chat Application - It is a web applicataion made using
                  React and for storing data using APIs.
                  It is fully fledge chat application and also we can create groups.
                </p>
              </NavLink>
                  ...
                  <>
                    ...
                    <Disclosure.Panel className="pb-2">
                      <NavLink to="/skills" className="flex flex-col group">
                        <p className="text-sm sm:text-base">
                          Programming - C,java,python, Frontend - React, Javascript,
                          HTML & CSS, ...
                        </p>
                        <span className="flex text-sm items-center mt-2 text-gray-500">
                  ...
                  <>
                    ...
                    <Disclosure.Panel className="pb-2 ">
                      <NavLink to="./contact" className="flex flex-col group">
                        <p className=" text-sm sm:text-base">
                          Gmail Id: Mugunthking491@gmail.com , ...
                        </p>
              ...
              <NavLink to="/skills" className="flex flex-col group mt-8">
                ...
                <p className="text-sm text-[#65696E] mt-2">
                  Programming - C,java,python, Frontend - React, Javascript, HTML & CSS,
                  ...
                </p>
              </NavLink>
            ...
            <div className="about flex flex-col mt-3">
              ...
              <p>
                <img
                  ...
                  alt="profileImage"
                />
                My name is Mugundhan and I am pursuing my Bachelor in 
                Technology from Vellore Institute of Technology
                and my specialization is in Computer Science
                Engineering. I have a deep interest in Web Development especially in frontend development 
                and Data Science and I have made some full
                data science using deep learning and also done web dev projects using React.
              </p>
